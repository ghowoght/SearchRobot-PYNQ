...
architecture behav of p_write_12bytes_s is 
    ...
    signal icmp_ln554_fu_82_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_0_reg_71 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln556_fu_94_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, jpeg_out_TREADY, ap_CS_fsm_state3, ap_CS_fsm_state2, icmp_ln554_fu_82_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln554_fu_82_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln554_fu_82_p2)
    begin
        if ((((icmp_ln554_fu_82_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln554_fu_82_p2)
    begin
        if (((icmp_ln554_fu_82_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln554_fu_82_p2 <= "1" when (i_0_reg_71 = ap_const_lv4_C) else "0";
    jpeg_out_TDATA <= p_q0;
    ...
    p_address0 <= zext_ln556_fu_94_p1(4 - 1 downto 0);
    ...
    zext_ln556_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_71),64));
end behav;
