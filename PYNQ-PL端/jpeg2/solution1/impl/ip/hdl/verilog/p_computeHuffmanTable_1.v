...
module p_computeHuffmanTable_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] code_value_2_fu_224_p2;
wire    ap_CS_fsm_state7;
reg   [15:0] code_value_0_reg_103;
reg   [4:0] k_0_reg_115;
reg   [15:0] code_value_1_reg_128;
reg   [31:0] j_0_reg_140;
wire   [63:0] zext_ln317_1_fu_168_p1;
wire   [63:0] zext_ln319_fu_185_p1;
wire   [63:0] zext_ln319_1_fu_219_p1;
reg   [7:0] pos_in_table_1_fu_48;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln315_fu_156_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        nr_codes_addr_reg_240 <= zext_ln317_1_fu_168_p1;
    end
end
...
assign code_value_2_fu_224_p2 = (code_value_1_reg_128 + 16'd1);

assign code_value_fu_207_p2 = code_value_1_reg_128 << 16'd1;

assign huffman_table_length_address0 = zext_ln319_1_fu_219_p1;

assign huffman_table_length_d0 = k_0_reg_115;

assign huffman_table_value_address0 = zext_ln319_1_fu_219_p1;
...
assign pos_in_table_fu_190_p2 = (pos_in_table_1_fu_48 + 8'd1);

assign std_table_address0 = zext_ln319_fu_185_p1;

assign zext_ln317_1_fu_168_p1 = add_ln317_fu_162_p2;

assign zext_ln317_fu_173_p1 = nr_codes_load_reg_245;

assign zext_ln319_1_fu_219_p1 = std_table_load_reg_273;

assign zext_ln319_fu_185_p1 = pos_in_table_1_fu_48;

always @ (posedge ap_clk) begin
    code_value_0_reg_103[0] <= 1'b0;
end

endmodule //p_computeHuffmanTable_1
