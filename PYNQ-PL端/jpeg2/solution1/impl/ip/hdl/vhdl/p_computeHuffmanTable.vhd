...
entity p_computeHuffmanTable is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of p_computeHuffmanTable is 
    ...
    signal code_value_3_fu_224_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln317_2_fu_168_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln319_1_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln319_fu_219_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal pos_in_table_2_fu_48 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    pos_in_table_2_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln315_fu_156_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                nr_codes_addr_reg_240 <= zext_ln317_2_fu_168_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    code_value_3_fu_224_p2 <= std_logic_vector(unsigned(code_value_1_reg_128) + unsigned(ap_const_lv16_1));
    ...
    huffman_table_length_address0 <= zext_ln319_fu_219_p1(8 - 1 downto 0);
    ...
    huffman_table_value_address0 <= zext_ln319_fu_219_p1(8 - 1 downto 0);
    ...
    pos_in_table_fu_190_p2 <= std_logic_vector(unsigned(pos_in_table_2_fu_48) + unsigned(ap_const_lv8_1));
    std_table_address0 <= zext_ln319_1_fu_185_p1(8 - 1 downto 0);
    ...
    zext_ln317_2_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln317_fu_162_p2),64));
    zext_ln317_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(nr_codes_load_reg_245),32));
    zext_ln319_1_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(pos_in_table_2_fu_48),64));
    zext_ln319_fu_219_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_table_load_reg_273),64));
end behav;
