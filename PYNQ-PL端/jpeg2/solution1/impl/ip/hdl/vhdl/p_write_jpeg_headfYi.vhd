...
entity p_write_jpeg_headfYi_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of p_write_jpeg_headfYi_rom is 
...
entity p_write_jpeg_headfYi is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of p_write_jpeg_headfYi is
    component p_write_jpeg_headfYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    p_write_jpeg_headfYi_rom_U :  component p_write_jpeg_headfYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
