...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p \
    op interface \
    ports { p_address0 { O 4 vector } p_ce0 { O 1 bit } p_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { jpeg_out_TDATA { O 8 vector } jpeg_out_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { jpeg_out_TVALID { O 1 bit } jpeg_out_TLAST { O 1 vector } } \
} "
} else {
