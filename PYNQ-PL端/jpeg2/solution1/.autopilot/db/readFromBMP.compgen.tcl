...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { JpegEncoder_buffer_address0 { O 14 vector } JpegEncoder_buffer_ce0 { O 1 bit } JpegEncoder_buffer_we0 { O 1 bit } JpegEncoder_buffer_d0 { O 8 vector } JpegEncoder_buffer_address1 { O 14 vector } JpegEncoder_buffer_ce1 { O 1 bit } JpegEncoder_buffer_we1 { O 1 bit } JpegEncoder_buffer_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rgb_in_TDATA { I 24 vector } rgb_in_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rgb_in_TREADY { O 1 bit } rgb_in_TLAST { I 1 vector } } \
} "
} else {
