set moduleName p_write_162bytes_s
set isTopModule 0
...
set C_modelName {_write_162bytes_}
set C_modelType { void 0 }
set C_modelArgList {
	{ p int 8 regular {array 162 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 8 }  { p_ce0 mem_ce 1 1 }  { p_q0 mem_dout 0 8 } } }
