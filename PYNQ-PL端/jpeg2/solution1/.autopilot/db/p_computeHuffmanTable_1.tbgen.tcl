set moduleName p_computeHuffmanTable_1
set isTopModule 0
...
set C_modelName {_computeHuffmanTable.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ nr_codes int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ std_table int 8 regular {array 12 { 1 3 } 1 1 }  }
	{ huffman_table_length int 5 regular {array 12 { 0 3 } 0 1 }  }
	{ huffman_table_value int 16 regular {array 12 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ std_table_address0 sc_out sc_lv 4 signal 1 } 
	{ std_table_ce0 sc_out sc_logic 1 signal 1 } 
	{ std_table_q0 sc_in sc_lv 8 signal 1 } 
	{ huffman_table_length_address0 sc_out sc_lv 4 signal 2 } 
	...
	{ huffman_table_value_address0 sc_out sc_lv 4 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "std_table_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "std_table", "role": "address0" }} , 
 	...
 	{ "name": "huffman_table_length_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "huffman_table_length", "role": "address0" }} , 
 	...
 	{ "name": "huffman_table_value_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "huffman_table_value", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	std_table { ap_memory {  { std_table_address0 mem_address 1 4 }  { std_table_ce0 mem_ce 1 1 }  { std_table_q0 mem_dout 0 8 } } }
	huffman_table_length { ap_memory {  { huffman_table_length_address0 mem_address 1 4 }  { huffman_table_length_ce0 mem_ce 1 1 }  { huffman_table_length_we0 mem_we 1 1 }  { huffman_table_length_d0 mem_din 1 5 } } }
	huffman_table_value { ap_memory {  { huffman_table_value_address0 mem_address 1 4 }  { huffman_table_value_ce0 mem_ce 1 1 }  { huffman_table_value_we0 mem_we 1 1 }  { huffman_table_value_d0 mem_din 1 16 } } }
}
