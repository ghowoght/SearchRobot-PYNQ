...
entity encodeToJPG_p_anoOgC_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of encodeToJPG_p_anoOgC_rom is 
...
entity encodeToJPG_p_anoOgC is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of encodeToJPG_p_anoOgC is
    component encodeToJPG_p_anoOgC_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    encodeToJPG_p_anoOgC_rom_U :  component encodeToJPG_p_anoOgC_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
