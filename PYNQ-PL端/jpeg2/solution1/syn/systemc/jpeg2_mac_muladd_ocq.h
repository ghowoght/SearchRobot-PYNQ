...
// ==============================================================
#ifndef __jpeg2_mac_muladd_ocq__HH__
#define __jpeg2_mac_muladd_ocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_mac_muladd_ocq) {
    ...
    SC_CTOR(jpeg2_mac_muladd_ocq):  simcore_mac_3_U ("simcore_mac_3_U") {
