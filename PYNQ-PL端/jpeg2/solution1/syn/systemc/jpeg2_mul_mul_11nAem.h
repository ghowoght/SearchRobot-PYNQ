...
// ==============================================================
#ifndef __jpeg2_mul_mul_11nAem__HH__
#define __jpeg2_mul_mul_11nAem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_mul_mul_11nAem) {
    ...
    SC_CTOR(jpeg2_mul_mul_11nAem):  ACMP_mul_us_U ("ACMP_mul_us_U") {
