...
#ifndef _p_write_word_s_HH_
#define _p_write_word_s_HH_
...
struct p_write_word_s : public sc_module {
    ...
    // Module declarations
    p_write_word_s(sc_module_name name);
    SC_HAS_PROCESS(p_write_word_s);
    ...
    sc_signal< sc_lv<8> > tmp_data_V_fu_64_p1;
    ...
    void thread_tmp_data_V_fu_64_p1();
