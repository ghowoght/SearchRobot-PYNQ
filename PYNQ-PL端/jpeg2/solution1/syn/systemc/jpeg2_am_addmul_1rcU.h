...
// ==============================================================
#ifndef __jpeg2_am_addmul_1rcU__HH__
#define __jpeg2_am_addmul_1rcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_am_addmul_1rcU) {
    ...
    SC_CTOR(jpeg2_am_addmul_1rcU):  simcore_am_1_U ("simcore_am_1_U") {
