...
#ifndef _p_write_12bytes_s_HH_
#define _p_write_12bytes_s_HH_
...
struct p_write_12bytes_s : public sc_module {
    ...
    // Module declarations
    p_write_12bytes_s(sc_module_name name);
    SC_HAS_PROCESS(p_write_12bytes_s);
    ...
    sc_signal< sc_lv<1> > icmp_ln554_fu_82_p2;
    sc_signal< sc_lv<4> > i_0_reg_71;
    sc_signal< sc_lv<64> > zext_ln556_fu_94_p1;
    ...
    void thread_icmp_ln554_fu_82_p2();
    ...
    void thread_p_ce0();
    void thread_zext_ln556_fu_94_p1();
