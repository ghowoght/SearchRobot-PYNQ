...
// ==============================================================
#ifndef __jpeg2_mac_muladd_mb6__HH__
#define __jpeg2_mac_muladd_mb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_mac_muladd_mb6) {
    ...
    SC_CTOR(jpeg2_mac_muladd_mb6):  simcore_mac_2_U ("simcore_mac_2_U") {
