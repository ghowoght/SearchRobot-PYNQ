...
#ifndef _p_write_byte_s_HH_
#define _p_write_byte_s_HH_
...
struct p_write_byte_s : public sc_module {
    ...
    sc_in< sc_lv<1> > JpegEncoder_outhebyte_last_V_read;
    sc_in< sc_lv<8> > value_r;
    ...
    sc_out< sc_logic > jpeg_out_TDATA_blk_n;
    sc_in< sc_logic > ap_ce;


    // Module declarations
    p_write_byte_s(sc_module_name name);
    SC_HAS_PROCESS(p_write_byte_s);
