...
// ==============================================================
#ifndef __jpeg2_mac_muladd_kbM__HH__
#define __jpeg2_mac_muladd_kbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_mac_muladd_kbM) {
    ...
    SC_CTOR(jpeg2_mac_muladd_kbM):  simcore_mac_0_U ("simcore_mac_0_U") {
