...
// ==============================================================
#ifndef __jpeg2_shl_32ns_32DeQ__HH__
#define __jpeg2_shl_32ns_32DeQ__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jpeg2_shl_32ns_32DeQ) {
    ...
    SC_CTOR(jpeg2_shl_32ns_32DeQ):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
