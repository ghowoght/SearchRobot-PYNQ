...
wire   [0:0] icmp_ln536_fu_82_p2;
reg   [6:0] i_0_reg_71;
wire   [63:0] zext_ln538_fu_94_p1;
reg   [2:0] ap_NS_fsm;
...
always @ (*) begin
    if ((((icmp_ln536_fu_82_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln536_fu_82_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign i_fu_88_p2 = (i_0_reg_71 + 7'd1);

assign icmp_ln536_fu_82_p2 = ((i_0_reg_71 == 7'd64) ? 1'b1 : 1'b0);
...
assign p_address0 = zext_ln538_fu_94_p1;

assign zext_ln538_fu_94_p1 = i_0_reg_71;

endmodule //p_write_64bytes_s
